...
export const MicrosoftWordIcon = () => (
  <svg aria-labelledby="simpleicons-microsoftword-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
    <title id="simpleicons-microsoftword-icon">Microsoft Word</title>
