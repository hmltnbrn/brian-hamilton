      ...
      <div className="section">
        ...
        <div className="section-paper projects-div flex flex-column align-center">
          <Card className="projects-paper">
            ...
            >
              <img src="images/classroom-library.png" alt="Classroom Library" />
            </CardMedia>
            <CardText>
          ...
          <Card className="projects-paper">
            ...
            >
              <img src="images/end-line.png" alt="end/line" />
            </CardMedia>
            <CardText>
          ...
          <Card className="projects-paper">
            ...
            >
              <img src="images/mirror-mirror.png" alt="Mirror, Mirrow 2017"/>
            </CardMedia>
            <CardText>
          ...
          <Card className="projects-paper">
            ...
            >
              <img src="images/train-movement.png" alt="NYCT Train Movement" />
            </CardMedia>
            <CardText>
          ...
          <Card className="projects-paper">
            ...
            >
              <img src="images/school-crimes.png" alt="NYC School Crimes" />
            </CardMedia>
            <CardText>
              Data anaysis and visualization of an <a href="https://data.cityofnewyork.us/" target="_blank" rel="noopener noreferrer">NYC OpenData</a> dataset pertaining to school crimes.<br/>
