        ...
        <div className="resume-section">
          ...
          <div className="section-right">
            <div className="resume-education">
              <h2><span className="primary-color">Graduate Center at the City University of New York</span></h2>
              <h3>New York, New York | 2016 - Present</h3>
              <p>Studying for a Master of Arts in Liberal Studies, specializing in data visualization and digital humanities.</p>
            </div>
            <div className="resume-education">
              <h2><span className="primary-color">Rensselaer Polytechnic Institute</span></h2>
              <h3>Troy, New York | 2010 - 2014</h3>
